...
import {
  getExtrinsicUrl,
  getContractUrl,
} from "../../lib/token/transactionUtil";
...
describe("token transfer util tests", () => {
  ...
  it("should return extrinsic url", async () => {
    ...
    expect(res).toEqual(
      "https://testnet.reefscan.com/extrinsic/0xaaecd50afdaba4c6af5d8a9fc2c0319659ee35bf3d6d69dac1ccfc584d039061"
    );
  });
  ...
  it("should return contract url", async () => {
    ...
    expect(res).toEqual(
      "https://testnet.reefscan.com/contract/0x0bCCa87E32044992e15DD85De6a7382c618a2519"
    );
  });
});
